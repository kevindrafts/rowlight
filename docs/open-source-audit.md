...
- The canonical repository name is `kevindrafts/rowlight`. GitHub secret scanning, push protection, and private vulnerability reporting are configured during publication and verified separately.
